...
class VolumeWeightedAveragePrice(FeatureBuilder):
    """FeatureBuilder that calculates the volume weighted average price
    from high and low price volumes."""
    ...
    def build(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        df["volume_weighted_average_price"] = (
            df["avgHighPrice"] * df["highPriceVolume"] + df["avgLowPrice"] * df["lowPriceVolume"]
